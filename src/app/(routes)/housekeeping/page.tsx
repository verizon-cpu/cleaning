    ...
    <section style={{
      ...
      <div style={{
        ...
        onMouseLeave={(e) => {
          ...
          <span style={{ color: '#FFD700', transition: 'all 0.3s ease' }}>House keeping in Boston?</span>
        </h2>
        ...
        onMouseLeave={(e) => {
          ...
          e.currentTarget.style.transform = 'scale(1)';
           ...
           When it comes to reliable housekeeping in Boston, OTON Cleaning stands out for a multitude of reasons. Our commitment to consistency, attention to your specific home's needs, and focus on your long-term satisfaction are just a few of the factors that set us apart. Here's why clients who value peace of mind choose us:
        </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          onMouseLeave={(e) => {
            ...
            <span style={{ color: '#FFD700', transition: 'all 0.3s ease' }}>House keeping service?</span>
          </h2>
          ...
          onMouseLeave={(e) => {
            ...
            Our cleaning company has highly trained and experienced House keepers in handling all types of cleaning tasks. Some of the categories included in our House keeping service include:
          </p>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          onMouseLeave={(e) => {
            ...
            House keeping Services in <span style={{
              color: '#FFD700',
              position: 'relative',
              display: 'inline-block',
              transition: 'all 0.3s ease',
          ...
          onMouseLeave={(e) => {
           ...
           Elevate Your Peace of Mind with Professional, Reliable, and Detailed Housekeeping Services, Tailored to Provide Consistent Cleanliness for Boston's Homes.
          </p>
