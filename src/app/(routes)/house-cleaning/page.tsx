      ...
      {isMobileMenuOpen && isMobile && (
        <div style={baseStyles.mobileMenuOverlay}>
          ...
          <div style={baseStyles.mobileMenuContent}>
            ...
            <div 
              style={baseStyles.mobileNavItem(activeMobileItem === 'Before/After')}
              onClick={() => handleNavigation('/before-after')}
              onMouseEnter={() => setActiveMobileItem('Before/After')}
              onMouseLeave={() => setActiveMobileItem(null)}
              onTouchStart={() => handleTouchStart(setActiveMobileItem, 'Before/After')}
              onTouchEnd={() => handleTouchEnd(setActiveMobileItem, null)}
            >
              Before/After
            </div>
    ...
    <section style={{
      ...
      <div style={{
        ...
        onMouseLeave={(e) => {
          ...
          <span style={{ color: '#FFD700', transition: 'all 0.3s ease' }}>House cleaning in Boston?</span>
        </h2>
        ...
        onMouseLeave={(e) => {
          ...
          e.currentTarget.style.transform = 'scale(1)';
           ...
           When it comes to house cleaning in Boston, OTON Cleaning stands out for a multitude of reasons. Our commitment to creating your personal sanctuary, meticulous attention to detail in every room, and dedication to giving you back your time are just a few of the factors that set us apart. Here's why busy homeowners and families choose us:
        </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          onMouseLeave={(e) => {
            ...
            <span style={{ color: '#FFD700', transition: 'all 0.3s ease' }}>House cleaning service?</span>
          </h2>
          ...
          onMouseLeave={(e) => {
            ...
            Our cleaning company has highly trained and experienced House cleaners in handling all types of cleaning tasks. Some of the categories included in our House cleaning service include:
          </p>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          onMouseLeave={(e) => {
            ...
            House Cleaning Services in <span style={{
              color: '#FFD700',
              position: 'relative',
              display: 'inline-block',
              transition: 'all 0.3s ease',
        ...
        <div style={{
          ...
          <div style={{
            ...
            onMouseLeave={(e) => {
              ...
              In a city as vibrant and bustling as Boston, maintaining a pristine home is essential to your comfort and peace of mind amidst a busy lifestyle. Boston, known for its rich history, academic institutions, and cultural attractions, keeps its residents on the move. A spotless house is your sanctuary from the hustle, not only enhancing daily living but also creating a healthier, more welcoming environment for your family and guests.
              </p>
              <p style={{
                fontSize: '1.125rem',
                fontWeight: 500,
